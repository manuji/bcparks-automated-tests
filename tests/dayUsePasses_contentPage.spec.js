...
test.describe('Day Use Passes Tests', ()=>{
//wait for the page to load before running the tests
  ...
  test('Verify the navigation to the Day-use passes page', async ({ page }) => {
      ...
      await expect(page).toHaveURL(`${process.env.URL}/reservations/day-use-passes/`);
  ...
  test('Verify the page content', async ({ page }) => {
      await page.goto(`${process.env.URL}/reservations/day-use-passes/`);
